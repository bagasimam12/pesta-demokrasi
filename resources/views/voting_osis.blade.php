...
<ul class="cards">
    ...
    <li>
        <a href="#kandidat-{{ $row->paslon_no }}" class="card h-100 card-paslon d-flex align-items-center text-center"
            style="width: 18rem">
            <div class="no-paslon">{{ $row->paslon_no }}</div>
            <img src="{{ asset($row->gambar) }}" alt="photo-profile" width="120" class="pt-4 rounded-circle" />
            <div class="card-body">
                <h5 class="card-title fw-bold m-0">Ketua</h5>
                <p class="card-text" style="font-size: 16px;">{{ $row->ketua }}</p>
                <h5 class="card-title fw-bold m-0">Wakil Ketua</h5>
                <p class="card-text ">{{ $row->wakil }}</p>
                <div class="row gap-2 d-flex justify-content-center">
                    ...
                    <button type="button" class="btn btn-primary col-5" data-toggle="modal" data-target="#modalMisi"
                        data-misi="{{ $row->misi }}">MISI</button>
                    <button data-toggle="modal" data-target="#modalVoteKandidat" data-ketua="{{ $row->ketua }}"
                        ...
                        class="btn btn-primary w-75">PILIH</button>
                </div>
            </div>
        </a>
    </li>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="lead text-dark fs-5">Dengan ini dengan penuh kesadaran dan dengan tanpa paksaan saya memilih
                    <b><span id="paslon"></span></b> sebagai calon ketua dan wakil ketua OSIS
...
<div class="modal fade" id="modalVisi" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalVisiLabel">VISI & MISI</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="modal fade" id="modalMisi" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalMisiLabel">VISI & MISI</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <hr>
                        <div id="misi" style="white-space: pre-line;line-height:1.9rem"></div>
                    </div>
                </div>
            </div>
        </div>
