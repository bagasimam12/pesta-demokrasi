...
<div class="card">
    <div class="card-body d-flex flex-column align-items-center justify-content-center py-4">
        <h2 class="text-wrap"><strong>{{ ConfigVoting::getConfig()->title }}</strong></h2>
            ...
            <div class="row">
                ...
                <div class="col-10">
                    <div class="form-floating my-2">
                        <input type="text" name="uuid" class="form-control rounded-4" autocomplete="off" id="inputNIS"
                            value="{{ old('uuid') }}" placeholder="NIS" required="required">
